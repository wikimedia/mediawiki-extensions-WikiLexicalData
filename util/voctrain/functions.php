...
function display_form() {
	...
	$form->addElement( 'select', 'mode', 'voc browser mode:', [ 'browser' => 'lookup dictionary', 'trainer' => 'vocabulary training' ] );
	...
	if ( $_REQUEST['settings'] == 1 ) {
		$form->addElement( 'text', 'wdlanguages_2', 'second output language:', [ 'value' => '', 'size' => 6, 'maxlength' => 6 ] );
		$form->addElement( 'text', 'wdlanguages_3', 'third output language:', [ 'size' => 6, 'maxlength' => 6 ] );
		$form->addElement( 'text', 'wdlanguages_4', 'fourth output language:', [ 'size' => 6, 'maxlength' => 6 ] );
		...
		$form->addElement( 'text', 'wdlanguages_2', 'first language you can understand:', [ 'size' => 6, 'maxlength' => 6 ] );
		$form->addElement( 'text', 'wdlanguages_3', 'second language you can understand:', [ 'size' => 6, 'maxlength' => 6 ] );
		$form->addElement( 'text', 'wdlanguages_4', 'third language you can understand:', [ 'size' => 6, 'maxlength' => 6 ] );

	} else {
		$form->addElement( 'hidden', 'wdlanguages_2', '', [ 'size' => 6, 'maxlength' => 6 ] );
		$form->addElement( 'hidden', 'wdlanguages_3', '', [ 'size' => 6, 'maxlength' => 6 ] );
		$form->addElement( 'hidden', 'wdlanguages_4', '', [ 'size' => 6, 'maxlength' => 6 ] );
		$link = build_get_uri_2( 'settings', '1', '' );
		echo '<a href="' . $link . '">edit settings and languages</a>';
	}

	if ( $_REQUEST['definedmeaning'] ) {
		$expression_group[] = &HTML_QuickForm::createElement( 'text', 'expression', 'search expression:', [ 'value' => '' , 'size' => 20, 'maxlength' => 256 ] );
		$form->updateElementAttr( 'expression', [ 'value' => '' ] );
		$expression_group[] = &HTML_QuickForm::createElement( 'text', 'wdexplanguage', 'source language of an expression <br />(leave blank to search all languages)', [ 'size' => 20, 'maxlength' => 256 ] );
	} else {
		$expression_group[] = &HTML_QuickForm::createElement( 'text', 'expression', 'search expression:', [ 'size' => 20, 'maxlength' => 256 ] );
		$expression_group[] = &HTML_QuickForm::createElement( 'text', 'wdexplanguage', 'source language of an expression <br />(leave blank to search all languages)', [ 'size' => 4, 'maxlength' => 256 ] );
	}

	$form->addGroup( $expression_group, 'Expression', 'Search Expression:', '&#160; only in this language:', 0 );

	if ( $_REQUEST['settings'] == 1 ) {
		$form->addElement( 'text', 'definedmeaning', 'definedmeaning (word-id):', [ 'value' => '', 'size' => 15 ] );
	}
...
function get_definition( $xml, $defined_meaning, $wdlanguages ) {
	$lang_rows['wdlanguage'] = [];
	$lang_rows['translated_text'] = [];
...
function get_expression( $xml, $defined_meaning, $wdlanguages ) {
	$lang_rows['wdlanguage'] = [];
	$lang_rows['expression'] = [];
	$lang_rows['indentical_meaning'] = [];
