...
Sprooche mussen dem ISO-639-3-Sproochecode entspriechen.</p>',
	...
	'addcollection' => 'Sammlung derbäisetzen',
	'ow_save' => 'Späicheren',
...
Одберете збирка за извоз. Во полето за јазици внесете список на ISO 639-3 јазични кодови, одделени со запирка. Започнете со јазиците од кои сакате да преведувате (одберете колку што сакате) и завршете со јазиците на кои ќе работите превод. Потоа стиснете на „Создај“ за да ја создадете податотеката.</p>',
...
Проверете ја мреж. адреса.',
	...
	'ow_Spelling' => 'Изговор',
	'ow_SuggestHint' => 'Стиснете да го измените изборот',
	'ow_Synonyms' => 'Синоними',
	'ow_SynonymsAndTranslations' => 'Синоними и преводи',
	'ow_Source' => 'Извор',
...
Не заборавајте да стиснете двапати за да проверите!',
...
请见[[{{MediaWiki:Ow editing policy url}}|我们的编辑政策]]。',
	...
	'transaction' => '交易日志',
	'ow_transaction_from_transaction' => '来自交易：',
